...
import com.anshul.buzzme.databinding.FragmentProfileBinding;
...
public class ProfileFragment extends Fragment {
    ...
    ProgressDialog pd;
    String uid,profileOrCoverPhoto, storagePath ="User_Profile";
    Uri imageuri;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    String description = "" + dataSnapshot1.child("bio").getValue();
                    String image = "" + dataSnapshot1.child("image").getValue();
                    // setting data to our text view
                    binding.username.setText(name);
                    binding.description.setText(description);
                    try {
                        Glide.with(getContext()).load(image).placeholder(R.drawable.profile_image).into(binding.profileImage);
                    } catch (Exception e) {
        ...
        binding.helpLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getActivity(),HelpActivityPage.class));
            }
        });
    ...
    private void showInfoChangeDialog() {
        String options[] = {"UserName", "Description"};
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (which == 0) {
                   ...
                   updateUsername("name");
                    ...
                    pd.setMessage("Changing Description");
    ...
    private void updateDescription(final String key) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        builder.setTitle("Update " + key);
                ...
                if (!TextUtils.isEmpty(value)) {
                    ...
                    databaseReference.child(firebaseUser.getUid()).updateChildren(result).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            // after updated we will show updated
                            Toast.makeText(getActivity(), "Description Updated ", Toast.LENGTH_LONG).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                    ...
                    if (key.equals("bio")) {
                        ...
                        query.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                                    String child = databaser.getKey();
                                    dataSnapshot1.getRef().child("bio").setValue(value);
                                }
                            }
...
//     checking storage permission ,if given then we can add something in our storage
    ...
    private void uploadProfileCoverPhoto(final Uri uri) {
        ...
        String filepathname = "Users/" + storagePath + "" + profileOrCoverPhoto + "_" + firebaseUser.getUid();
